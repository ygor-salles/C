...
É definido pelo fator de balancemanto FB, onde FB é -1, 0 ou 1
Ou seja, a diferença de altura da árvore da direita em relação a esquerda e vice versa não deve 
ser maior que 1 ou menor que menos 1, 
(não pode haver dois nós a mais na esquerda ou na direita, pois assim a árvore estaria desbalanceada)
